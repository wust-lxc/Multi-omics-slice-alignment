...
def main():
    ...
    if not processed_file.exists():
        raise FileNotFoundError("h3k27ac_processed.h5ad not found. Run previous steps first.")
    ...
    sc.pl.embedding(
        ...
        s=8,
        show=False,
        title="Mouse brain H3K27ac mclust domains",
    )
    ...
    sc.pl.embedding(
        ...
        s=2,
        show=False,
        title="Mouse brain H3K27ac reference 3D",
    )
